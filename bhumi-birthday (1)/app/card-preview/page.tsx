...
import { Cake, Star, Heart, Gift, ArrowLeft } from "lucide-react"
        ...
        <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 max-w-md w-full">
          <CardContent className="p-8 text-center">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-red-500 to-purple-600 hover:from-red-600 hover:to-purple-700 text-white py-6 text-lg font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 mb-8"
            >
